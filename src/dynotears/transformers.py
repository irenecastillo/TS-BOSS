...
# (https://github.com/mckinsey/causalnex). The only change is replacing
# `t.index.is_integer()` with `pd.api.types.is_integer_dtype(t.index)`
# to avoid a pandas FutureWarning.
